                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const vid = data?.voice_id || data?.voiceId || data?.id || "";
                      if (!vid) {
                        throw new Error(data?.detail || data?.error || "resposta sem voice_id");
                      }
                      toast.success(`Voz clonada! voice_id: ${String(vid).slice(0, 14)}...`);
                      await load();
