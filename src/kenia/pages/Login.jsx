              ...
              <TabsContent value="login" className="mt-6">
                <form onSubmit={handleLogin} className="space-y-5" data-testid="login-form">
                  ...
                  <div className="relative my-2">
                    <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-nude-200" /></div>
                    <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="bg-card px-2 text-nude-500">ou continue com</span></div>
                  </div>
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => handleOAuth("google")}
                    className="w-full h-11 border-nude-300 bg-card hover:bg-nude-50 text-nude-800 font-medium"
                  ...
                  >
                    <svg className="w-4 h-4 mr-2" viewBox="0 0 48 48" aria-hidden="true">
                      ...
                      <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.1C29.3 35 26.8 36 24 36c-5.3 0-9.6-3.4-11.3-8l-6.5 5C9.6 39.6 16.2 44 24 44z"/>
                      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4.1 5.5l6.2 5.1C41 35.5 44 30.2 44 24c0-1.2-.1-2.3-.4-3.5z"/>
                    </svg>
                    Entrar com Google
                  </Button>
