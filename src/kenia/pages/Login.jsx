...
import { Gem, ArrowRight, Apple } from "lucide-react";
...
export default function Login() {
  ...
  const handleSocialLogin = async (provider) => {
    ...
    try {
      ...
      toast.error(err?.message || "Erro ao entrar com a rede social");
      setLoading(false);
    }
  };
            ...
            <Tabs defaultValue="login">
              ...
              <TabsContent value="login" className="mt-6">
                <form onSubmit={handleLogin} className="space-y-5" data-testid="login-form">
                  ...
                  <p className="text-[11px] leading-relaxed text-nude-500 text-center font-sans-body">
                    Facebook, Instagram, LinkedIn, TikTok e demais redes são conectadas no fluxo de publicação/agendamento, não como login do painel.
                  </p>
